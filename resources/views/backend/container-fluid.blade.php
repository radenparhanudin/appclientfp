            ...
            <div class="panel panel-default">
               ...
               <div class="panel-body panel-scroll" style="height:300px">
                  <table class="table table-striped table-hover" id="sample-table-1">
                     ...
                     <tbody>
                        <tr>
                           <td class="center"><img src="{{ asset('public/template') }}/assets/images/avatar-1.jpg" alt="image" /></td>
                           <td>Peter Clark</td>
                           <td class="hidden-xs">
                        ...
                        <tr>
                           <td class="center"><img src="{{ asset('public/template') }}/assets/images/avatar-2.jpg" alt="image" /></td>
                           <td>Nicole Bell</td>
                           <td class="hidden-xs">
                              <a href="#" rel="nofollow" target="_blank">
                                 nicole@example.com
                        ...
                        <tr>
                           <td class="center"><img src="{{ asset('public/template') }}/assets/images/avatar-3.jpg" alt="image" /></td>
                        ...
                        <tr>
                           <td class="center"><img src="{{ asset('public/template') }}/assets/images/avatar-5.jpg" alt="image" /></td>
                           <td>Kenneth Ross</td>
                           <td class="hidden-xs">
                              <a href="#" rel="nofollow" target="_blank">
                                 kenneth@example.com
                        ...
                        <tr>
                           <td class="center"><img src="{{ asset('public/template') }}/assets/images/avatar-4.jpg" alt="image" /></td>
                  ...
                  <div class="panel panel-default">
                     ...
                     <div class="panel-body panel-scroll" style="height:460px">
                        <ol class="discussion">
                           <li class="other">
                              <div class="avatar">
                                 <img alt="" src="{{ asset('public/template') }}/assets/images/avatar-4.jpg">
                              </div>
                              <div class="messages">
                                 <p>
                                    Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat.
                           ...
                           <li class="self">
                              <div class="avatar">
                                 <img alt="" src="{{ asset('public/template') }}/assets/images/avatar-1.jpg">
                              </div>
                              <div class="messages">
                                 <p>
                                    Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat.
                           ...
                           <li class="other">
                              <div class="avatar">
                                 <img alt="" src="{{ asset('public/template') }}/assets/images/avatar-3.jpg">
                              </div>
                              <div class="messages">
                                 <p>
                                    Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat.
