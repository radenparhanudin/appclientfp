...
<head>
	...
	<title>{{ config('app.description') }} - Login</title>
							...
							<div class="col-lg-6">
								<div class="p-5">
									<div class="text-center">
										<h1 class="h4 text-gray-900 mb-4 font-weight-bold">{{ config('app.description') }}</h1>
									</div>
									<form class="user">
										...
										<a href="{{ asset('public/sbadmin') }}/index.html" class="btn btn-primary btn-user btn-block font-weight-bold text-uppercase">
											Login
										</a>
									</form>
								</div>
